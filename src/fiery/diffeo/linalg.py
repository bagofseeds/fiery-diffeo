...
def jhj3(jac, hess):
    ...
    out[3] = (
        j10 * (h00 * j00 + h01 * j01 + h02 * j02)
        + j11 * (h01 * j00 + h11 * j01 + h12 * j02)
        + j12 * (h02 * j00 + h12 * j01 + h22 * j02)
    )
    out[4] = (
        j20 * (h00 * j00 + h01 * j01 + h02 * j02)
        + j21 * (h01 * j00 + h11 * j01 + h12 * j02)
        + j22 * (h02 * j00 + h12 * j01 + h22 * j02)
    )
    out[5] = (
        j20 * (h00 * j10 + h01 * j11 + h02 * j12)
        + j21 * (h01 * j10 + h11 * j11 + h12 * j12)
        + j22 * (h02 * j10 + h12 * j11 + h22 * j12)
    )
    return out
