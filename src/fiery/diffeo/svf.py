...
from fiery.diffeo.flows import bracket, compose, compose_jacobian, jacobian
from fiery.diffeo.linalg import batchdet, batchmatvec, jhj


def exp(
    vel, steps=8, bound='circulant', anagrad=False, backend=default_backend
):
